...
//    const METHOD_GUEST_CUSTOMER = 'guest_customer';
    ...
    {
        $mode = Mage::getStoreConfig('firecheckout/general/registration_mode');
        // @todo check '?register' parameter
        return $mode === 'optional-checked';
    }
    ...
    {
        if (Mage::helper('core')->isModuleOutputEnabled('Amasty_Methods')) {
            if (!Mage::helper('ammethods')->canUseMethod($method, 'shipping')) {
                return false;
            }
        }
    ...
    public function applyShippingMethod($methodCode = null)
    {
        ...
        } elseif (1 === $count && !Mage::helper('firecheckout')->isOnecolumnMode()) {

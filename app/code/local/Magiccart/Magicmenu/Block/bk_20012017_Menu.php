                                                ...
                                                if(count($catList)){
                                                    ...
                                                    foreach ($catList as $cat) {
                                                      //if($i >= $this->getGeneralCfg('limit_items')) break;
                                                        ...
                                                        $catdata = Mage::getModel('catalog/category')->load($cat->getId());
                                                        $color_code = $catdata->getColorCode();
                                                        $url = '<a style="color:'.$color_code.'"href="'. Mage::getBaseUrl(). $cat->getUrlPath() .'">'.$this->__($cat->getName()).' '.$this->getCatLabel($cat) .'</a>';

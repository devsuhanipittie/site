...
class Magidev_Sort_Model_Search extends Mage_Sitemap_Model_Resource_Catalog_Product
{
	...
	public function getCollection($storeId)
	{
		...
		$this->_select = $this->_getWriteAdapter()->select()
				...
				->where("{$this->_alias}.entity_id NOT IN(SELECT product_id FROM {$this->getTable('catalog/category_product')} WHERE category_id={$this->_categoryId} ) AND ({$this->_alias}.sku LIKE '{$this->_query}%' OR name_table.value LIKE '%{$this->_query}%') ")
